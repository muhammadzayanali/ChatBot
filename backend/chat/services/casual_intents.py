...
No changes needed from Flask version — this module is file-based and has no framework dependencies.
"""
import json
import re
...
def _load_intents() -> list:
    ...
    # Look for intents.json in the django_backend root directory
